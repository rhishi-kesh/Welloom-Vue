    ...
    <section>
        <div class="container mx-auto">
            <div class="text-center py-8 w-[75%] m-auto">
                ...
                <p class="mt-8">Millions of wedding photos stay unseen in camera rolls, and even the best photographers
                    can
                    miss the most
                    heartfelt moments.</p>

                <p class="mt-3">Our platform lets you effortlessly collect and share every memory, ensuring nothing is
                    lost
                    and the moments that matter most are captured forever.</p>
